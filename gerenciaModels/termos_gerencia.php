...
$dao = new livrosDAO;
$termos = $dao->getTermos();
$controller ='termos_gerencia';
?>
<h1 class="titulo_gerencia">Termos</h1>
...
<div class="ui styled sixteen fluid wide accordion novo_gerencia " >
    ...
    <div class=" content">
        <div class="ui mini form form-gerencia-<? echo $controller ?>">            
            <h4 class="ui dividing header titulo_edicao_gerencia"><i class="book  icon"></i>Editar Termos</h4>
...
<table id="lista_gerencia" class="ui padded table" >
    ...
    <tbody>
        <? foreach ($termos as $termo) { ?>
            <tr class="livro_edicao_gerencia edit_item_gerencia" data-item='<? echo $termo['id']?>' data-controller="<?echo $controller?>">
                <td class="collapsing"><? echo $termo['id']?></td>
                <td><? echo utf8_encode($termo['text'])?></td>
            </tr>
        <? } ?>
    </tbody>
</table>
