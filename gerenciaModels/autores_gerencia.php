...
<div class="ui styled sixteen fluid wide accordion novo_gerencia " >
    ...
    <div class=" content">
        <div class="ui mini form form-gerencia-<? echo $controller ?>">            
            <h4 class="ui dividing header titulo_edicao_gerencia"><i class="book  icon"></i>Editar Autor</h4>
...
<table id="lista_gerencia" class="ui padded table" >
    ...
    <tbody>
        <? foreach ($autores as $autor) { ?>
            <tr class="livro_edicao_gerencia edit_item_gerencia" data-item='<? echo $autor['id']?>' data-controller="<?echo $controller?>">
                <td class="collapsing"><? echo $autor['id']?></td>
                <td><? echo utf8_encode($autor['text'])?></td>
            </tr>
        <? } ?>
    </tbody>
</table>
