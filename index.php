...
<body id="page-top" data-spy="scroll" data-target="#mainNav">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
		<div class="container">
			...
			<button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Alterar navegação">
	...
	<header class="masthead" id="home" style="background-image: url('assets/img/fundo-header/<?echo $bg[$i]?>');" >
		<div class="header-content">
			<div class="header-content-inner">
				...
				<a class="btn btn-primary btn-xl importar" style="margin-top: 10px;" >Importar</a>
			</div>
		</div>
	</header>
